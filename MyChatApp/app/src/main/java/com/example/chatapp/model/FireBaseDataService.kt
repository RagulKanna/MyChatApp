...
//import com.example.mychatapplication.model.Constant.CONTENT
//import com.example.mychatapplication.model.Constant.FIREBASE_CHATS_COLLECTION
//import com.example.mychatapplication.model.Constant.FIREBASE_GROUP_CHATS_COLLECTION
//import com.example.mychatapplication.model.Constant.FIREBASE_MESSAGES_COLLECTION
//import com.example.mychatapplication.model.Constant.FIREBASE_PHONE
//import com.example.mychatapplication.model.Constant.FIREBASE_PROFILE_IMAGE_URL
//import com.example.mychatapplication.model.Constant.FIREBASE_STATUS
//import com.example.mychatapplication.model.Constant.FIREBASE_TOKEN
//import com.example.mychatapplication.model.Constant.FIREBASE_USERNAME
//import com.example.mychatapplication.model.Constant.FIREBASE_USERS_COLLECTION
//import com.example.mychatapplication.model.Constant.MESSAGE_ID
//import com.example.mychatapplication.model.Constant.MESSAGE_TYPE
//import com.example.mychatapplication.model.Constant.PARTICIPANTS
//import com.example.mychatapplication.model.Constant.SENDER_ID
//import com.example.mychatapplication.model.Constant.SENT_TIME
...
//
//class FirebaseDatabaseService: FirebaseMessagingService {
...
//                .collection(FIREBASE_MESSAGES_COLLECTION)
//                .orderBy(SENT_TIME, Query.Direction.DESCENDING)
...
//            val listenerRef =
//                db.collection(FIREBASE_USERS_COLLECTION).addSnapshotListener { snapshot, error ->
//                    if (error != null) {
//                        this.offer(null)
//                        Log.e(TAG, "snapshot listener error")
//                        error.printStackTrace()
...
//                "participants" to participants
//            )
//            db.collection(FIREBASE_GROUP_CHATS_COLLECTION).document(autoId).set(map)
//                .addOnCompleteListener {
//                    if (it.isSuccessful) {
...
//                                    val groupInfo =
//                                        GroupInfo(groupId, groupName, groupImageUrl, participants)
...
//    }
//
//    suspend fun sendNewMessageToGroup(
//        currentUser: UserDetails, selectedGroup: GroupInfo,
...
//            )
//            db.collection(FIREBASE_GROUP_CHATS_COLLECTION).document(selectedGroup.groupId)
//                .collection(
//                    FIREBASE_MESSAGES_COLLECTION
//                ).document(autoId).set(firebaseMessage).addOnCompleteListener {
//                    if (it.isSuccessful) {
...
//        return suspendCoroutine { callback ->
//            db.collection(FIREBASE_USERS_COLLECTION).document(uid).update(map)
//                .addOnCompleteListener {
//                    if (it.isSuccessful) {
